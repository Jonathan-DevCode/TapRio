...
<body>
    ...
    <div id="main" class="texto-cor-primaria correct-icons">
        ...
        <div id="carouselExampleIndicators" class="carousel slide mt-5" v-if="bannersMiddle">
            ...
            <div class="carousel-inner">
                <div class="carousel-item middle " v-for="(banner,index) in bannersMiddle" :class="index == 0 ? 'active' : '' ">
                    <video controls="muted" autoplay="autoplay" loop name="media"><source src="https://taprio.com.br/media/slides/adm.mp4" type="video/mp4"></video>
                </div>
        ...
        <div class="container" :class="bannersMiddle ? 'mt-5' : 'mt-5 pt-5'" style="margin-top: 50px;">
            <form action="${baseUri}/imovel/salvar_anuncio" method="POST">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h3>A Tap Rio oferece serviços especializados tanto para venda quanto para aluguel de imóveis. Nossa equipe está preparada para ajudá-lo a encontrar o comprador ou locatário ideal para o seu imóvel.</h3>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control cel" inputmode="numeric" minlength="10" name="imovel_proprietario_telefone" required>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                        <div class="form-group">
                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-2 mt-3">
                        <div class="form-group">
                            ...
                            <select id="" class="form-control" name="imovel_tipo_negociacao">
                                <option value="venda" selected>Vender</option>
                    ...
                    <input type="hidden" name="imovel_site_type" value="venda_alugue">
                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-2 mt-3">
                        <div class="form-group">
                            <label for="">CEP</label>
                            <input type="text" class="form-control cep" maxlength="9" oninput="handleZipCode(event)" inputmode="numeric"  name="imovel_cep">
                    ...
                    <div class="espaco-superior text-center">
                        ...
                        <h3>
<p>Se você está interessado em vender o seu imóvel, nós iremos oferecer suporte desde a avaliação do preço de mercado até a negociação e o fechamento do negócio. Contamos com estratégias eficientes de marketing e uma ampla rede de contatos para garantir uma venda rápida e satisfatória.</p>

<p>Caso prefira alugar seu imóvel, nós cuidaremos de todos os aspectos, desde a divulgação, seleção de potenciais inquilinos, elaboração de contratos e até mesmo a gestão da locação. Nossa equipe se encarregará de realizar visitas, analisar documentos e oferecer suporte completo ao longo de todo o processo.</p>
...
<p>Na Tap Rio, nosso objetivo é proporcionar uma experiência tranquila e profissional, independentemente de você optar pela venda ou aluguel do seu imóvel. Entre em contato conosco para obter mais informações e dar o próximo passo rumo ao sucesso na negociação do seu imóvel.</p>
    ...
    <div class="whatsapp-button">
        <a target="_blank" href="https://api.whatsapp.com/send?phone=+55<?= $data['config']->whatsNum ?>&text=Olá, vim pelo site, gostaria de ter mais informações sobre vender ou alugar meu imóvel">
        ...
        createApp({
                ...
                methods: {
                    ...
                    async getBannerMiddle() {
                        try {
                            const response = await axios.get('${baseUri}/imovel/getSlideVendaOuAlugue');
