...
<head>
    ...
    <title>${config_site_title} | Atributos</title>
...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>
                                        ...
                                        Cadastre e gerencie os atributos que seus imóveis vão possuir. Ex: Área útil, quartos, banheiros etc.
                                    </h5>
                                    <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="hidden-xs-down">Atributo</th>
                                                <th>Ícone</th>
                                        ...
                                        <tbody>
                                            <tr v-for="att in atributos">
                                                <td class="hidden-xs-down">{{att.atributo_titulo}}</td>
                                                <td><i :class="'fa ' + att.atributo_icone"></i></td>
                                                <?php if (Usuario::verifyPermission('imoveis', 'gerenciar') || Usuario::verifyPermission('imoveis', 'remover')) : ?>
                                                    <td class="d-print-none text-left" width="100">
                                                        <?php if (Usuario::verifyPermission('imoveis', 'gerenciar')) : ?>
                                                            <a v-if="lista_fixa && lista_fixa.indexOf(att.atributo_titulo) == -1" class="btn btn-sm btn-primary waves-effect waves-light" data-toggle="tooltip" title="editar" v-on:click="show_edit(att)">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        <?php endif; ?>

                                                        <?php if (Usuario::verifyPermission('imoveis', 'remover')) : ?>
                                                            <button v-if="lista_fixa && lista_fixa.indexOf(att.atributo_titulo) == -1" class="btn btn-sm btn-danger" data-toggle="tooltip" title="remover" v-on:click="remover(att)">
        ...
        <div id="modalAdd" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= Http::base() ?>/Atributo/gravar" method="post">
                        <input type="hidden" name="atributo_id" id="atributo_id">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="">Nome <span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" required id="atributo_titulo" name="atributo_titulo">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="atributo_icone" id="atributo_icone" required class="form-control">
    ...
    @(admin.layout.mainjs)
    <script src="${baseUri}/view/admin/atributo/index.js"></script>
    <script>
        $(".supermenu-imoveis").addClass("menu-open");
        $(".menu-imoveis-atributos").addClass("active");
    </script>
</body>
