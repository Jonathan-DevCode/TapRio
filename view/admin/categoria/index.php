...
<head>
    ...
    <title>${config_site_title} | Categorias</title>
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-sm-6">
                            <h1>Categorias
                                <?php if (Usuario::verifyPermission('imoveis', 'gerenciar') || Usuario::verifyPermission('imoveis', 'remover')) : ?>
                                    <a class="btn btn-primary btn-sm ml-3" href="<?= Http::base() ?>/categoria/nova"><i class="fa fa-plus"></i>Nova</a>
                                <?php endif; ?>
                            </h1>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>
                                        ...
                                        Cadastre e gerencie as categorias que seus imóveis irão possuir.
                                    </h5>
                                                ...
                                                <?php if (Usuario::verifyPermission('imoveis', 'gerenciar') || Usuario::verifyPermission('imoveis', 'remover')) : ?>
                                                    <td class="d-print-none text-left" width="100">
                                                        <?php if (Usuario::verifyPermission('imoveis', 'gerenciar')) : ?>
                                                            <a class="btn btn-sm btn-primary waves-effect waves-light" data-toggle="tooltip" title="editar" :href="'<?= Http::base() ?>/categoria/editar/' + c.categoria_imovel_id">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= Http::base() ?>/categoria/gravar" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="categoria_imovel_id" id="categoria_imovel_id">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <label for="">Nome da categoria <span class="text-danger">*</span> </label>
                                    <input type="text" class="form-control" required id="categoria_imovel_nome" name="categoria_imovel_nome">
                                </div>
                                <div class="col-sm-12">
                                    <label for="categoria_imovel_img_capa">Selecione uma Imagem</label>
                                    <input type="file" id="categoria_imovel_img_capa" name="categoria_imovel_img_capa" data-allowed-file-extensions="jpg jpeg png gif" class="dropify" />
                                </div>
                            </div>
                        </div>
    ...
    @(admin.layout.mainjs)
    <script src="${baseUri}/view/admin/categoria/index.js"></script>
    <script>
