<div class="row">
    <div class="col-12 col-sm-12">
        <p><b>Dica: </b> Neste sistema, atributos são as características de um imóvel.</p>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            <label for="">Atributo</label>
            <select id="imovel_atributos" class="form-control">
                <option value="0">Selecione uma opção</option>
                <option v-if="atributos_disponiveis != null" v-for="att in atributos_disponiveis" :value="att.atributo_id">{{ att.atributo_titulo }}</option>
            </select>
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
        <div class="form-group">
            <label for="">Valor do atributo</label>
            <input type="number" inputmode="numeric" class="form-control" id="imovel_atributo_valor">
        </div>
    </div>

    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 align-self-end">
        <div class="form-group">
            <button type="button" v-on:click="vincula_atributo()" class="btn btn-success btn-block"><i class="fa fa-check"></i> Vincular</button>
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 align-self-end">
        <div class="form-group">
            <button type="button" onclick="$('#modalAddAtributo').modal('show')" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Criar novo atributo</button>
        </div>
    </div>    
</div>
<hr>
...
<div class="row">
    <div class="col-sm-12 mt-3">
        <h4>Atributos vinculados ao imóvel</h4>
    </div>
    <div class="col-sm-12 mt-2" v-if="atributos_indisponiveis != null">
        <table class="table table-bordered">
            ...
            <tbody>
                <tr v-for="att in atributos_indisponiveis">
                    <td>{{ att.atributo_titulo }}</td>
                    <td>{{ att.atributo_imovel_valor }}</td>
                    <td width="50">
                        <a class="btn btn-danger btn-sm" title="Remover" v-on:click="show_remove_atributo(att)"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
...
<!-- modais -->
<div id="modalRemoveAtributo" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mySmallModalLabel">Remover Atributo</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <p class="text-center" style="color: black">Você está prestes à remover um vínculo entre atributo e imóvel e esta ação não pode ser desfeita.<br>
            ...
            <div class="modal-footer">
                ...
                <button type="button" v-on:click="remove_atributo()" class="btn btn-danger waves-effect waves-light"><i class="fa fa-trash"></i> Remover</button>
            </div>
        </div>
    </div>
</div>

<div id="modalAddAtributo" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mySmallModalLabel">Adicionar Atributo</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="atributo_titulo_novo">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="atributo_icone_novo" class="form-control">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="atributo_valor_novo">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal"><i class="fa fa-times-circle"></i> Cancelar</button>
                <button type="button" v-on:click="salvar_atributo()" class="btn btn-primary waves-effect waves-light"><i class="fa fa-check-circle"></i> Salvar</button>
            </div>
        </div>
    </div>
</div>